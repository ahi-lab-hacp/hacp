...
![Why HACP: the same legitimate agent is allowed with valid human provenance and denied when an attacker supplies a hijacked request](docs/assets/why-hacp.png)
