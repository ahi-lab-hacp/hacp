...
![Why HACP: a ticket website allows the same legitimate agent to book one $542 ticket matching a signed $600 limit, but denies a hijacked action requesting 100 tickets](docs/assets/why_hacp.png)
